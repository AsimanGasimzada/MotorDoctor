...
public class OrderItemAutoMapper : Profile
{
    public OrderItemAutoMapper()
    {
        ...
        .ForMember(x => x.ProductSize, x => x.Ignore())
        .ForMember(x => x.StaticPrice, x => x.MapFrom(x => x.ProductSize.Price))
        .ForMember(x => x.StaticDiscount, x => x.MapFrom(x => x.ProductSize.Discount));
        ...
        CreateMap<OrderItemGetDto, BasketItemGetDto>().ReverseMap()
            .ForMember(x => x.StaticPrice, x => x.MapFrom(x => x.ProductSize.Price))
            .ForMember(x => x.StaticDiscount, x => x.MapFrom(x => x.ProductSize.Discount));
    }
}
